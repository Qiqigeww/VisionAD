...
# 相比较于 dade_visa_test.py , 从 one-for-one 改成了 one-for-all 的模式;
...
def get_logger(name, save_path=None, level='INFO'):
    ...
    if not save_path is None:
        ...
        fileHandler = logging.FileHandler(os.path.join(save_path, 'log_visa.txt'))
...
def train():
    ...
    # encoder_name = 'beit3_vit_base_16'
