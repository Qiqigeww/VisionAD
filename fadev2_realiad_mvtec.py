...
def train():
    ...
    for i, item in enumerate(train_item_list):
        train_data = RealIADDatasetFADE(root=args.train_data_path, category=item, transform=train_transform,
    ...
    model = FADEv2(encoder=encoder, bottleneck=bottleneck, decoder=decoder, interested_layers=interested_layers,
    ...
    for epoch in range(int(np.ceil(total_iters / len(train_dataloader)))):
        ...
        for bad_img, bad_gt, good_img, good_gt, support_img in train_dataloader:
            ...
            loss = 5 * focal_loss(pred, gt) + bce_loss(pred, gt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str,
                        default='fadev2_realiad_s4sv_mvtec_dinov2br_fs35811_saug_sa3ca3_pt_it10k_ams1e4_w1kcosa_5f5bce5_b8_s1')
