...
from models.vision_transformer import Block as VitBlock, Attention, CrossAttention, CrossBlock, bMlp, Mlp
...
def train():
    ...
    bottleneck = bMlp(embed_dim, embed_dim * 4, embed_dim, drop=0.1)
    bridge = Mlp(embed_dim, embed_dim * 4, embed_dim)
    ...
    model.load_state_dict(torch.load(
        os.path.join(args.save_dir,
                     'rade_imagenet_mvtec_dinov2br_draem_fs8_brd_dp1_saug_casa3_it20k_adam1e3_w1kcos_b8_s1',
